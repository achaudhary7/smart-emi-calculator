...
const config = {
    ...
    filesToDeploy: [
        ...
        '50-lakh-home-loan-emi/index.html',
        'hdfc-home-loan-calculator/index.html',
        'reduce-home-loan-tenure/index.html',
        'about/index.html',
        'privacy-policy/index.html',
        'contact/index.html',
        'how-it-works/index.html',
        'balance-transfer-calculator/index.html',
        'amortization-schedule-explained/index.html',
